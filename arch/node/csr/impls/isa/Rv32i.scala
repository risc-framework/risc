package arch.node.csr.impls.isa.rv32i
...
object CsrRv32iIsa extends RegisteredNodeUtils[CsrIsaImpl] with Rv32iCsrUOpConsts with Rv32iCsrMap {
  override def utils: CsrIsaImpl = new CsrIsaImpl with Rv32iCsrUOpConsts with Rv32iCsrMap {
    ...
    override def table(implicit p: Parameters): Seq[(Register, CsrUpdateBehavior)] = Seq(
      (
      ...
      (Register("mvendorid", CSR_MVENDORID.value, 0x0L, writable = false), NormalUpdate),
